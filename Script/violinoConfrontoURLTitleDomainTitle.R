...
print(length(filtered_dataset$URLTitleMatchScore))
# Crea il grafico a violino con mediana e quartili
print(ggplot(filtered_dataset, aes(x = Type, y = URLTitleMatchScore, fill = Type)) +
  ...
  labs(
    title = "Confronto del URLTitleMatchScore tra URL legittimi e di phishing",
    x = "Tipo di URL",
    y = "URLTitleMatchScore",
    fill = "Tipo di URL"
  ) +
  theme_minimal() +
  theme(
